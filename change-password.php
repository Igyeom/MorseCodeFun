...
<html>
  ...
  <body style="background:black;color:white;">
    ...
    <form action="changepwd-process.php" method="POST">
      <input type="password" placeholder="Old Password" name="oldpwd" autocomplete="off"><br>
      <input type="password" placeholder="New Password" name="newpwd" autocomplete="off"><br>
      <input type="password" placeholder="Repeat New Password" name="newpwd2" autocomplete="off"><br>
