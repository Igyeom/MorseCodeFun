...
<html>
  ...
  <body style="background:black;color:white;">
    ...
    <input id="input" type="text" placeholder="Text to translate...">
    <input id="translation" type="text" placeholder="Output goes here...">
    <br><br>
    <p>Frequency:</p>
    <input type="number" value="1000" id="freq" min="300" max="1000">
    <input type="submit" value="Set Frequency" id="submit" onmousedown="setfreq();" onmouseup="black();"><br>
    <br><br><br><br>
